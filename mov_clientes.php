<?php
	...
	$active_productos="";
	$active_usuarios="";
	$titulo="Movimiento Clientes | Deposito La Fortuna";
	/* Connect To Database*/
...
<html lang="es">
  ...
  <body>
	...
	<div class="container">
		...
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<a  href="salidas.php" class="btn btn-info"><span class="glyphicon glyphicon-list" ></span> Salida Caja</a>
			</div>
			<div class="btn-group pull-right">
				&nbsp;
			</div>
			<div class="btn-group pull-right">
				<a  href="entradas.php" class="btn btn-info"><span class="glyphicon glyphicon-list" ></span> Entrada Caja</a>
				</div>
				<div class="btn-group pull-right">
				&nbsp;
			</div>
		<div class="btn-group pull-right">
				<a  href="salidas_bancos.php" class="btn btn-info"><span class="glyphicon glyphicon-list" ></span> Salida Banco</a>
			</div>
			<div class="btn-group pull-right">
				&nbsp;
			</div>
			<div class="btn-group pull-right">
				<a  href="entradas_bancos.php" class="btn btn-info"><span class="glyphicon glyphicon-list" ></span> Entrada Banco</a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Movimientos Clientes</h4>
		</div>
			...
			?>
				<form class="form-horizontal" role="form" id="datos_clientes">
						<div class="container">
							<div class='col-md-5'>
					...
					<div class='col-md-5'>
						...
						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Nombre de Cliente</label>
							<div class="col-md-5">
	...
	<script type="text/javascript" src="js/mov_clientes.js"></script>
