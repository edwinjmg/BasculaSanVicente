	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar Nueva Salida</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_salida" name="guardar_salida">
		  ...
		  <div id="form_cliente" class="form-group row">
					...
					<div class="col-sm-8">
						...
						<label for="saldo_cliente" class="col-sm-3 control-label"  style="font-size:16px">SALDO</label>
					<div class="col-sm-8">
						<input type="text" class="form-control input-sm" id="saldo_cliente" name="saldo_cliente"  style="font-size:16px;text-align: right;font-weight:bold" placeholder="SALDO" readonly>
					</div>
		  ...
		  <div id="form_banco" class="form-group row" hidden>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="detalle" name="detalle" placeholder="Descripción de la Salida" required maxlength="255" ></textarea>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="valor" name="valor" placeholder="Valor de la Salida" required pattern="^[0-9]{1,16}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="16">
				</div>
			  </div>
