<?php
	...
	$active_productos="";
	$active_usuarios="";
	$titulo="Ventas | Deposito La Fortuna";
	/* Connect To Database*/
  ...
  <body>
	...
	<div class="container">
		...
		<div class="panel-heading">
			...
			?>
				<form class="form-horizontal" role="form" id="datos_ventas">
						<div class="container">
							<div class='col-md-5'>
					...
					<div class='col-md-5'>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre del cliente o # de Venta" onkeyup='load(1);'>
							</div>
							...
							<div class="col-md-2 " >
								<input type="text" id="peso_total" style="font-size:12pt;text-align:right;font-weight: bold;" name="peso_total" class="form-control" readonly>
							</div>
							<label for="valor_total" class="col-md-1 control-label">Valor Total</label>
							<div class="col-md-2 " >
								<input type="text" id="valor_total" style="font-size:12pt;text-align:right;font-weight: bold;" name="valor_total" class="form-control" readonly>
							</div>
