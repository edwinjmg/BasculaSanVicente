<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$titulo="Nueva Salida | Deposito La Fortuna";
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevasalida"><span class="glyphicon glyphicon-plus" ></span> Nueva Salida</button>
			</div>
			<h4><i class='glyphicon glyphicon-edit'></i> Salidas</h4>
		</div>
				<div class="panel-body">
		<?php 
			include("modal/registrar_salida.php");
			include("modal/editar_salida.php");
		?>
