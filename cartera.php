<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$titulo="Cartera | Deposito La Fortuna";
?>
<!DOCTYPE html>
<html lang="es">
  <head>
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<button type='button' class="btn btn-info" id="actualizar_cartera"><span class="glyphicon glyphicon-refresh" ></span> Actualizar Cartera</button>
			</div>
	...
	?>
	<script type="text/javascript" src="js/cartera.js"></script>
  </body>
</html>