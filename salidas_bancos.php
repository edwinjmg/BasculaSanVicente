<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$titulo="Salidas Bancos | Deposito La Fortuna";
...
<html lang="es">
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevaSalida"><span class="glyphicon glyphicon-plus" ></span> Nueva Salida Banco</button>
			</div>
			<h4><i class='glyphicon glyphicon-edit'></i> Salidas Bancos</h4>
		</div>
				<div class="panel-body">
		<?php 
			include("modal/registrar_salida_bancos.php");
			include("modal/editar_salida_bancos.php")
		?>
	...
	<script type="text/javascript" src="js/salidas_bancos.js"></script>
