<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$titulo="Entradas Bancos | Deposito La Fortuna";
...
<html lang="es">
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevaEntrada"><span class="glyphicon glyphicon-plus" ></span> Nueva Entrada Banco</button>
			</div>
			<h4><i class='glyphicon glyphicon-edit'></i> Entradas Bancos</h4>
		</div>
				<div class="panel-body">
		<?php 
			include("modal/registrar_entrada_bancos.php");
			include("modal/editar_entrada_bancos.php")
		?>
	...
	<script type="text/javascript" src="js/entradas_bancos.js"></script>
