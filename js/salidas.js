$(document).ready(function(){
	...
	load(1);
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_salidas.php?action=ajax&page='+page+'&fecha_inicial='+fecha_inicial+'&fecha_final='+fecha_final,
  ...
  event.preventDefault();
	...
	if (parseInt($(this).val())==0) {
    	...
    	function obtener_datos(id){
			...
			var valor_salida = $("#valor_salida"+id).val();
			if (id_banco=="") {
				$("#mod_form_banco").hide();
		...
		function imprimir_salida(id_salida){
			VentanaCentrada('./pdf/documentos/ver_salida.php?id_salida='+id_salida,'Salida','','1024','768','true');
		}