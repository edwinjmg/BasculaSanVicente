...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <?php include("encabezado_entrada_banco.php");?>
    <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				...
				$sql_fecha=mysqli_query($con,"select DATE_FORMAT(fecha_entrada_banco, '%d de %M de %Y') AS fecha, RIGHT(fecha_entrada_banco, 8) AS hora FROM entrada_banco where entrada_banco.id_entrada_banco='".$id_entrada."'");
