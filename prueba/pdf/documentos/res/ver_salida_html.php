...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
      ...
      <br>  
      <br>    
    <?php include("encabezado_salida.php");?>
    <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				...
				$sql_fecha=mysqli_query($con,"select DATE_FORMAT(fecha_salida, '%d de %M de %Y') AS fecha, RIGHT(fecha_salida, 8) AS hora FROM salida where salida.id_salida='".$id_salida."'");
	...
	<br>
	<br>  <div style="font-size:11pt;text-align:center;font-weight:bold">-------------------------------------------------</div>
