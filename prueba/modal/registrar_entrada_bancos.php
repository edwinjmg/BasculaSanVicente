	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar Nueva Entrada Bancos</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_entrada_banco" name="guardar_entrada_banco">
		  ...
		  <div id="form_cliente" class="form-group row">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="detalle1" name="detalle1" placeholder="Descripción de la Entrada" required maxlength="255" ></textarea>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="valor1" name="valor1" placeholder="Valor de la Entrada" required pattern="^[0-9]{1,16}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="16">
				</div>
			  </div>
