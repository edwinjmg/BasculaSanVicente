	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_salida" name="editar_salida">
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-primary" id="actualizar_salida">Actualizar datos</button>
		  </div>
		  </form>
		</div>
	  </div>
